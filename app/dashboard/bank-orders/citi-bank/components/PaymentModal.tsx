// app/dashboard/bank-orders/citi-bank/components/PaymentModal.tsx
'use client';
      ...
      <div className="payment-modal">
        ...
        <div className="modal-body">
          ...
          <div className="instructions">
            ...
            <p>⏱️ Payment will be confirmed after network confirmation. Items will be sent to your email within 15 minutes.</p>
          </div>
